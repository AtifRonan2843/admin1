...
app.config['DATABASE'] = r'C:\path\to\your\project\folder\database.db'
...
def add_doctor():
    if request.method == 'POST':
        ...
        # Add logic to insert the new doctor into your database
        # (e.g., using SQLAlchemy or another ORM)

        # Redirect back to the doctors list after successful addition
        return redirect(url_for('doctors_list'))
    
    # Render the Add Doctor form template on GET request
